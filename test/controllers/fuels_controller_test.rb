...
class FuelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fuel" do
    assert_difference('Fuel.count') do
      post fuels_url, params: { fuel: { amount: @fuel.amount, date: @fuel.date, name: @fuel.name, payment_typology_id: @fuel.payment_typology_id, place: @fuel.place, service_station_id: @fuel.service_station_id } }
    end
  ...
  test "should update fuel" do
    patch fuel_url(@fuel), params: { fuel: { amount: @fuel.amount, date: @fuel.date, name: @fuel.name, payment_typology_id: @fuel.payment_typology_id, place: @fuel.place, service_station_id: @fuel.service_station_id } }
